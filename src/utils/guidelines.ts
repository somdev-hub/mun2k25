...
Steps taken for improvement, both nationally and globally */
  ...
  "Rules & Rights": [
    ...
    },
    {
      ...
      content:
        "Delegates who want to pass a motion or resolution must follow the voting procedures outlined in the rules of procedure. The chair will call for a vote, and delegates will raise their placards to indicate their position. The majority vote determines the outcome of the motion or resolution. Delegates must vote based on their country's stance and the merits of the proposal. The voting process is a critical aspect of the conference, as it determines the adoption of resolutions and the decisions made by the committee. If a delegate wins the majority vote, the resolution is passed. If not, the resolution is rejected. Winning the majority vote gains extra points for the delegate.",
      images: []
    },
    {
