  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        description: [
          "Mr. Hitesh Mishra(2020-24) representing the United States of America answers tough questions during the conference both from delegates and the jury. He was asked about the US's involvement in global issues and wars. Delegates from Russia, China etc stated that the US's involvement in foreign affairs and wars led to international instability. Ranging from the Iraq war to the ongoing crisis in Ukraine, the delegate was asked to justify the issues. The delegate engaged in debates with fellow delegates and provided a clear stance on US foreign policy and how they plan to maintain stability in the world. The delegate shows active support to Ukraine and accused China of not disclosing the actual data of COVID-19 figures leading to massive deaths in the States. "
        ]
      },
      {
